...
########################################################################
pathImage = "/home/sam/Projects/dataset/My_OMR/1.png"
...
# cv2.namedWindow("imgCanny",cv2.WINDOW_FREERATIO)
# cv2.namedWindow("Final Result", cv2.WINDOW_FREERATIO)
...
while True:
    ...
    imgCanny = cv2.Canny(imgBlur, 40, 100)  # APPLY CANNY
